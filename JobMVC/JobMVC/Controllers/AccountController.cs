...
namespace JobMVC.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> RegisterEmployee(RegisterVM registerVm)
        {
            ...
            var newFileName = file.FileName.Length > 50 ? file.FileName.Substring(40) : file.FileName;

            await using (var writer = new FileStream(@"wwwroot/images/"+ newFileName, FileMode.Create))
            {
